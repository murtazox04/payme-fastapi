...
class PaymeSubscribeReceipts:
    ...
    @payme_request
    async def __request(self, data) -> dict:
        """
    ...
    async def receipts_create(self, amount: float, order_id: int) -> dict:
        """
        ...
        return await self.__request(to_json(**data))

    async def receipts_pay(self, invoice_id: str, token: str, phone: str) -> dict:
        """
    ...
    async def receipts_send(self, invoice_id: str, phone: str) -> dict:
        """
    ...
    async def receipts_cancel(self, invoice_id: str) -> dict:
        """
    ...
    async def receipts_check(self, invoice_id: str) -> dict:
        """
    ...
    async def receipts_get(self, invoice_id: str) -> dict:
        """
    ...
    async def receipts_get_all(self, count: int, _from: int, _to: int, offset: int) -> dict:
        """
